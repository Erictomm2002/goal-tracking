      ...
      <div style={{
        ...
        {step === 1 && (
          <>
            ...
            <div style={{ fontSize: 12, color: "#cbd5e1", marginBottom: 20, lineHeight: 1.6 }}>
            ...
            {[
              ...
              <div key={label} style={{ marginBottom: 14 }}>
                <div style={{ fontSize: 9, letterSpacing: 2, color: "#cbd5e1", marginBottom: 6 }}>{label}</div>
            ...
            <div style={{ marginBottom: 14 }}>
              <div style={{ fontSize: 9, letterSpacing: 2, color: "#cbd5e1", marginBottom: 6 }}>
                LINK ẢNH (tuỳ chọn)
              </div>
                ...
                {habits.map(h => (
                  <div key={h.title} style={{
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      {h.subtitle && (
                        <div style={{ fontSize: 10, color: "#cbd5e1", marginTop: 2 }}>{h.subtitle}</div>
                      )}
                      {h.description && (
                        <div style={{ fontSize: 9, color: "#cbd5e1", marginTop: 3, lineHeight: 1.4, whiteSpace: "pre-wrap", maxHeight: 32, overflow: "hidden" }}>
                          {h.description}
                        </div>
                      )}
                    </div>
                    <span onClick={() => removeHabit(h.title)}
                      style={{ cursor: "pointer", color: "#cbd5e1", fontSize: 16, opacity: 0.6 }}>×</span>
                  </div>
                ))}
              </div>
            )}
